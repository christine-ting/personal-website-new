...
const ProjectsSection = () => {
  const projects = [
    ...
    },
    {
      ...
      description:
        'A collaborative task management application with real-time updates, notifications, and team management features.',
    ...
    },
    {
      ...
      description:
        'Interactive dashboard for financial data visualization with customizable widgets and real-time data updates.',
  ...
  return (
    <section
      id="projects"
      className="py-2 relative bg-gradient-to-br from-slate-50 via-blue-50/10 to-slate-50 overflow-hidden"
    >
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            ...
            >
              <div
                className={`w-full h-48 ${project.image} flex items-center justify-center`}
              >
              ...
              <div className="p-6">
                ...
                <p className="text-yellow-700 mb-4 line-clamp-3">
                  {project.description}
                </p>
